---
title: "Run GENESPACE vignettes - Cotton genomes treated as tetraploids with an outgroup"
author: "JTLovell"
date: "22-Feb 2022"
output: pdf_document
---
...
```{r cottParam}
cottonSplit <- list(
  wd = file.path(baseDir, "cotton_split_outgroup"),
  speciesIDs = "cotton",
...
Also set the synteny parameters. 
...
```{r sesh}
gparCotton2x_outgroup <- gparCotton2x
save(gparCotton2x_outgroup, file = file.path(baseDir, "gparCotton2x_outgroup.rda"))
sessionInfo()
```
